...
import com.dashboard.config.TestContainersConfig;
 ...
 * 
 * Тестирует работу приложения с реальными контейнерами:
 * - PostgreSQL для тестирования базы данных
 * - Проверка работы сервисов с реальными данными
 */
@SpringBootTest
@Testcontainers
@ActiveProfiles("test")
class DashboardIntegrationTest {
    ...
    void contextLoads() {
        ...
        assertThat(serverMonitorService).isNotNull();
        assertThat(serverVersionService).isNotNull();
    }
