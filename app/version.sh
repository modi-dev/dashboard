...
table=$(${oc_dir}/oc get pods -o jsonpath="{range .items[*]}{'<tr>'}{'<td align="left">'}{.spec.containers[*].name}{'</td>'}{'<td align="left">'}{.spec.containers[?(@.name=='main')].image}{'</td>'}{'<td>'}{.metadata.creationTimestamp}{'</td>'}{'<td align="left">'}{range .spec.containers[?(@.name=='main')]}{.name}{'</br>'}{'req.cpu: '}{.resources.requests.cpu}{'|____|'}{'lim.cpu: '}{.resources.limits.cpu}{'</br>'}{'req.mem: '}{.resources.requests.memory}{'|____|'}{'lim.mem: '}{.resources.limits.memory}{'</br>'}{end}{'</td>'}{'<td>'}{.spec.containers[0].ports[0].containerPort}{'</td>'}{'<td>'}{.status.phase}{'</td>'}{'</tr>'}{end}")
