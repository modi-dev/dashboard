...
const FourOhFour = () => {
  ...
  return (
    ...
    React.createElement(Message, { className: "return-link", href: "/#", rel: "noreferrer noopener" }, "Попробуйте обновить страницу или написать DevOps"), 


    React.createElement(Logo, { className: "bear-logo--tears" }), 
    React.createElement(Code, { className: "four-oh-four__code" }, "Извините"), 
    React.createElement(CodeMessage, { className: "four-oh-four__code-message" }, "Что-то пошло не так"))));
