 ...
 * 
 * ВАЖНО: Версия Kubernetes теперь синхронизируется вместе с подами в KubernetesPodsSyncService.
 * Этот инициализатор выполняет первоначальную загрузку, чтобы данные были доступны сразу при старте.
 * 
